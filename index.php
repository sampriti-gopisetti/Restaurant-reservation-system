                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            ...
                            <a href="menu.php" class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft">Reserve A Table</a>
                        </div>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <h1 class="mb-4">Welcome to <i class="fa fa-utensils text-primary me-2"></i>EasyDine</h1>
                        <p class="mb-4"><h6 class="text-uppercase mb-0">Come explore different restaurants near you and have unique experiences</p>
                        <p class="mb-4">Try the diverse cusines available near you without having to wait for a table</p><h6>
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center border-start border-5 border-primary px-3">
                                    ...
                                    <div class="ps-4">
                                        ...
                                        <h6 class="text-uppercase mb-0">Collaborations<h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h5 class="section-title ff-secondary text-center text-primary fw-normal">Restaurant Menu</h5>
                    <h1 class="mb-5">Most Popular Restaurants Nearby</h1>
                </div>
                        ...
                        <li class="nav-item">
                            <a class="d-flex align-items-center text-start mx-3 ms-0 pb-3 active" data-bs-toggle="pill" href="#tab-1">
                                ...
                                <div class="ps-3">
                                    ...
                                    <h6 class="mt-n1 mb-0">Breakfast places</h6>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="d-flex align-items-center text-start mx-3 pb-3" data-bs-toggle="pill" href="#tab-2">
                                ...
                                <div class="ps-3">
                                    ...
                                    <h6 class="mt-n1 mb-0">Launch places</h6>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="d-flex align-items-center text-start mx-3 me-0 pb-3" data-bs-toggle="pill" href="#tab-3">
                                ...
                                <div class="ps-3">
                                    ...
                                    <h6 class="mt-n1 mb-0">Dinner places</h6>
                                </div>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-6 bg-dark d-flex align-items-center">
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <h1 class="text-white mb-4">Reserve A Table Online</h1>
                        <form>
                            <div class="row g-3">
                                <div class="col-md-6">
